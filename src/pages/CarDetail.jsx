          ...
          <div className="lg:col-span-1">
            <div className="sticky top-20 space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Why Buy From AutoPrime</p>
              ...
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
                ...
                <div className="flex gap-2">
                  <a
                    href={`https://wa.me/?text=Check out this ${car.name} on AutoPrime: ${window.location.href}`}
                    target="_blank"
                    rel="noopener noreferrer"
